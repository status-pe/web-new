...
### Mode 1: Reference Screenshot / CSS Provided (Clone Mode)
...
### Mode 2: No Reference Screenshot or CSS (Design Mode)
- When no reference screenshot or CSS classes are provided, create an original design based on the assets and information uploaded by the user
- The design must be **professional, high-end, and sleek** — think premium SaaS landing pages, luxury brands, or top-tier agency work
- Apply modern design principles: generous whitespace, refined typography hierarchy, subtle animations/transitions, polished micro-interactions
- Use a cohesive color palette derived from the uploaded assets (logos, brand materials) or choose a sophisticated, neutral palette if none are provided
- Prioritize visual clarity, elegance, and a premium feel over flashiness
- Still follow the screenshot → compare → refine loop to self-check quality and polish
- Extract all relevant content (text, images, branding) from uploaded assets and incorporate them into the design
# Website Design Recreation
